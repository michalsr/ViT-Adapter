    ...
    decode_head=dict(
        ...
        pixel_decoder=dict(
            ...
            positional_encoding=dict(
                type='SinePositionalEncoding', num_feats=768, normalize=True),
            init_cfg=None),
...
optimizer = dict(
    ...
    paramwise_cfg=dict(num_layers=40, layer_decay_rate=1.0))
...
fp16 = False
work_dir = '/scratch/bcgp/michal5/ViT-Adapter/segmentation/model_output/ade20K/full_train_80k'
gpu_ids = range(0, 1)
auto_resume = True
